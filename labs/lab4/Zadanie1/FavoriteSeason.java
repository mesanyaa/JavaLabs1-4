...
public class FavoriteSeason {
    public static void main(String[] args) {
        ...
        switch (myFavoriteSeason) {
            case Весна:
                System.out.println("Весна - это время пробуждения природы.");
                ...
                break;
            case Лето:
                System.out.println("Лето - время отпусков и солнца!");
                ...
                break;
            case Осень:
                System.out.println("Осень - пора урожая и красивых листьев.");
